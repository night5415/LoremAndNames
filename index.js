...
getRandomDate = (maxAge = 90) => {
    ...
    const { genders = [] } = config, lNameMax = lastNames.length - 1, fNameMax = firstNames.length - 1, fRand = getRandomNumber(fNameMax), lRand = getRandomNumber(lNameMax), firstName = firstNames.at(fRand), lastName = lastNames.at(lRand), birthDay = getRandomDate(), val = getRandomNumber(genders.length - 1, 0), gender = genders[val];
    return {
        firstName,
        lastName,
        birthDay,
